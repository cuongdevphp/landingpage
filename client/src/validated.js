...
export default function Render({ validated = true }) {
    ...
    return <div className={CSS$} ref={ref}>
        <div className="header">
            <div style="padding: 10px 15px 0; display: grid;">
                ...
                <h2 style=" color: rgb(0, 55, 123); ">Đăng ký mở tài khoản thành công!</h2>
                <p style="line-height: 1.5;text-align: left; max-width: 780px; margin: 0 auto;">
                    Công ty Chứng khoán Bản Việt vừa gửi cho Quý khách email về bộ Hợp đồng mở tài khoản Chứng khoán kèm hướng dẫn hoàn thiện Hợp đồng.Trong vòng 01 ngày làm việc, nhân viên tư vấn dịch vụ của Bản Việt sẽ chủ động liên hệ để hỗ trợ Quý khách.
                    <br /><br />
                    Trong khi chờ nhận được thông tin tài khoản chính thức, bây giờ Quý nhà đầu tư đã có thể trải nghiệm phần mềm giao dịch qua
                </p>
            </div>
            <div className="features" style="margin-top: 20px">
